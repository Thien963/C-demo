...
#include <ctime>
using namespace  std;
map<string,Staff> listStaff = Staff::addMapStaff("C:\\Users\\admin\\Desktop\\GitHub\\project_staff\\fileStaff.csv");
...
void DateStaffManagement::createFileById(string id){
    string s = "C:\\Users\\admin\\Desktop\\GitHub\\project_staff\\"+id+".txt";
    ofstream MyFile(s);
    MyFile.close();
}
